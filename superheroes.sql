...
VALUES
    (
        ...
        'Born on another planet and stranded here during an intergalactic training exercise, Muscles muscles expanded to gigantic proportion in Earths nitrogen-rich atmosphere, giving her amazing strength. The extra arms don''t hurt, either.'
    );
...
VALUES
    (
        'Lieutenant Lidar',
        'If you don''t tell the truth, you won''t get far. Whos on the case? Lieutenant Lidar!',
